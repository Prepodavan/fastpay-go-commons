...
func (createContract *ContractCreateRequest) SetDefaults() {
	if createContract.Type == currency_exchange_contracts_category_enum.Undefined {
		createContract.Type = currency_exchange_contracts_category_enum.CurrencyExchangeContract
	}
}
